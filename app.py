...
# Allow users to select two variables from the dataset for visualization
    ...
    st.markdown("1. More comments are usually associated with more likes, however, there are outliers demonstrating a high comment to like ratio, perhaps becuase these videos are controversial and thus encourage engagement. Number of comments is more closely correlated to views than likes, which is sensible considering not all videos are controversial.")
